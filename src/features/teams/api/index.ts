...
import { getAllWithRequestParameter, postSingleRequestParameter } from "@/shared/api/genericAPI";
...
export const getCurrentUserTeams: () => Promise<ApiResponse<TeamPublicOutput[]>> = async (): Promise<ApiResponse<TeamPublicOutput[]>> => {
  return await getAllWithRequestParameter(API_ENDPOINTS.TEAMS.CURRENT_USER_TEAMS, {});
};
